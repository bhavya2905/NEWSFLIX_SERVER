...
import {updateArticles, deleteArticles, getRecommendation, incrementCatCount, decrementCatCount, comment, deleteComment, getArticles, createArticles} from "../controlers/ArticlesController.js";
...
articlesRoutes.post('/deletecomment/:id',deleteComment);
